 ...
 * @author ouyangfan
 * @version 0.0.1
 * @date 2015-03-30 09:07
 */
public class IdCardUtil {
    /*
     * 身份证校验方法
     * @link http://zhidao.baidu.com/link?url=sOYq5Il6TlNjPbypEH4jAYPgj9CWwq1jlm61m0L1Yas_p9hzEIt_EWHdbdZjqFO1r310iUn-cI_Ikp0EdYy3R_
    ...
    private static boolean isDate(String strDate) {
        Pattern pattern = Pattern.compile("^((\\d{2}(([02468][048])|" +
                "([13579][26]))[\\-\\/\\s]?((((0?[13578])|(1[02]))[\\-\\/\\s]?((0?[1-9])|([1-2][0-9])|" +
